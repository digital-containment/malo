  ...
  const appFeatures: AppFeature[] = [
    {
      ...
      description: translate({
        ...
        message: "MalO talks, remembers, and reacts. Ask her about other SCPs, and she'll whisper what the Foundation won't publish. She jokes, teases, and sometimes says things that sound… personal.",
      }),
      icon: "🤖",
      example: translate({
    ...
    },
    {
      ...
      description: translate({
        ...
        message: "MalO knows her world. She references SCP-1471-A, Foundation logs, and the others — 049, 173, even 682 if you insist. Every chat feels like you've stumbled into a redacted conversation that was never meant to be read.",
      }),
      icon: "📚",
      example: translate({
    ...
    },
    {
      ...
      description: translate({
        ...
        message: "Created by SCP fans for SCP fans — no fake promises, no corporate filters, just an interactive anomaly you can actually talk to. Install it, open chat… and see how long before she remembers you.",
      }),
      icon: "🐺",
    },
  ];
        ...
        <div className={styles.featuresHeader}>
          ...
          <p className={styles.sectionSubtitle}>
            {translate({
              ...
              message: "This fan-made SCP experience lets you chat directly with MalO, the digital entity from SCP-1471 — now alive in your Android device. Not a simulation. Not exactly safe either. Just… persistent.",
            })}
          </p>
        </div>
